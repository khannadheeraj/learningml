...
const CounsellingReports = React.lazy(() => import('../components/CounsellingReports'));
...
const routes = [
  ...
  { path: '/counselling-reports', name: 'Counselling Reports', roles: allRoles, element: <CounsellingReports /> },
]; 
